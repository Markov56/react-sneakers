    ...
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        ...
        <div className="cards">
          <div className="card">
            ...
            <div className="card__bottom">
              ...
              <button className="card__btn">
                <img width={32} height={32} src="/images/plus.svg" alt="add to card" />
              </button>
            </div>
          </div>

          <div className="card">
            <img className="card__img" src="/images/sneakers/2.jpg" alt="sneakers" />
            <h5 className="card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__bottom">
              <div className="card__price-box">
                <span>Цена:</span>
          ...
          <div className="card">
            <img className="card__img" src="/images/sneakers/3.jpg" alt="sneakers" />
            <h5 className="card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__bottom">
              <div className="card__price-box">
                <span>Цена:</span>
          ...
          <div className="card">
            <img className="card__img" src="/images/sneakers/4.jpg" alt="sneakers" />
            <h5 className="card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__bottom">
              <div className="card__price-box">
                <span>Цена:</span>
